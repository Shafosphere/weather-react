...
function WeatherDetails({ data }) {
  return (
    <div className="body-right-current">
      ...
      <div className="temperatureApparent-value">
        {data.temperatureApparent} °C
      </div>
      <div className="precipitationProbability-value">
        <div className="precipitationProbability-value-text">
          {data.precipitationProbability} %
        </div>
        <div className="precipitationProbability-value-icon">
          <WiUmbrella />
        </div>
      </div>
      ...
      <div className="windSpeed-value">
        ...
        <div className="windSpeed-value-icon">
          <WiStrongWind />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="footer-current">
      ...
      <div className="pressureSurfaceLevel">
        <div className="pressureSurfaceLevel-icon">
          <WiBarometer />
        </div>
        <div className="pressureSurfaceLevel-value">
...
export default function CurrentWeather({ data }) {
  ...
  const currentDateValue = moment(currentMinutelyData.time).format(
    "dddd, DD/MM/YYYY"
  );
  return (
          ...
          <div className="body-left-current">
            <WeatherIcon
              ...
              precipitationProbability={
                currentMinutelyData.precipitationProbability
              }
            />
          </div>
